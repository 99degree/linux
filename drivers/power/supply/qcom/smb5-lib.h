...
int smblib_read(struct smb_charger *chg, u16 addr, u8 *val, const char *);
int smblib_masked_write(struct smb_charger *chg, u16 addr, u8 mask, u8 val,const char *);
int smblib_write(struct smb_charger *chg, u16 addr, u8 val,const char *);
int smblib_batch_write(struct smb_charger *chg, u16 addr, u8 *val, int count,const char *);
int smblib_batch_read(struct smb_charger *chg, u16 addr, u8 *val, int count,const char *);
