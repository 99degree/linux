...
static const struct camss_subdev_resources csiphy_res_sc7180[] = {
	...
	{
		.regulators = {},
		.clock = {  "camnoc_axi_clk", /* bindly copy from dts */
                        "soc_ahb_clk",
                        "slow_ahb_src_clk",
                        "cpas_ahb_clk",
                        "cphy_rx_clk_src",
		...
		.clock_rate = { {0}, {0}, {0}, {19200000}, {270000000}, {0}, {300000000}, {0}, },
		.reg = { "csiphy0" },
		.interrupt = { "csiphy0" },
		.ops = &csiphy_ops_3ph_1_0
	},
...
static const struct camss_subdev_resources csid_res_sc7180[] = {
	/* CSID0 */
	{
		...
		.clock_rate = { {0}, {0}, {0}, {0}, {0}, {0}, {270000000}, {0}, {0}, {0}, {360000000}, {0}, {0}, },
		.reg = { "csid0" },
		.interrupt = { "csid0" },
		.ops = &csid_ops_gen2
	},
...
static const struct camss_subdev_resources vfe_res_sc7180[] = {
	/* VFE0 */
	{
		...
		.clock_rate = { {0}, {0}, {0}, {0}, {0}, {0}, {360000000}, {0}, {0}, },
		.reg = { "vfe0" },
		.interrupt = { "vfe0" },
		.line_num = 4,
		.has_pd = true,
